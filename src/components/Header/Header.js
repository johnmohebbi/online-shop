...
//actions
import { searchAction } from "../../Redux/Products/ActionProducts";
//logo
      ...
      <header className="bg-slate-200 md:flex  md:justify-between py-2">
        <section className="flex px-2 justify-between  items-center md:justify-start">
          ...
          >
            ...
            <ul className="mt-9  text-xl font-light md:flex md:mt-0 md:font-normal  md:text-xl md:flex-1">
        ...
        <div className=" px-2 flex justify-between items-center">
          <div className="relative">
            ...
            {searchSuggestions.length ? (
              <ul className="bg-indigo-200 absolute top-10 left-2 z-50 w-full">
                {
                   searchSuggestions.map(suggestion=><SearchSuggestions key={suggestion.id} product={suggestion} />)
                }
              </ul>
            ):null}
          </div>
