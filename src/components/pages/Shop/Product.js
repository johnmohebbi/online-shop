  ...
  return (
      ...
      <div onClick={(e)=> props.clickHandler(product)} className="flex flex-row-reverse  w-[90%] mx-auto md:mx-0 mb-2 md:max-w-sm rounded-md shadow-md border-2 md:mb-5">
        ...
        <div className="px-4 pb-3 flex flex-col justify-between">
            ...
            <h2 className="mt-1 text-lg font-semibold truncate w-full">{product.name}</h2>
            </Link>
            <div className="w-36 flex items-center mt-3.5 mb-5">
            ...
            <div className="flex flex-col justify-between text-lg font-semibold">
                ...
                <button className="text-white bg-blue-700 hover:bg-blue-800  font-medium rounded-md text-xs px-3 py-1.5 text-center grow" onClick={addToCartHandler}>add to cart</button>
            </div>
        </div>
      </div>
