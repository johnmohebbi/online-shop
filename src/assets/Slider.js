        ...
        <SplideSlide>
          <div className="relative">
            ...
            <div className=" text-center absolute top-7 right-[15%] md:top-28">
              ...
              <a className=" text-lg font-light underline-offset-4 underline hover:font-normal md:text-xl " href="/">shop Now</a>
            </div>
          </div>
        </SplideSlide>
        <SplideSlide>
          <div className="relative">
            <img src={SliderWoman} alt="woman" />
